...
export function StudentOnboardingFields({
  ...
  return (
    <div className="space-y-4 text-left">
      <p className="text-xs font-bold uppercase tracking-wide text-gray-500">Student details (optional)</p>
      <div>
...
export function MentorOnboardingFields({
  ...
  return (
    <div className="space-y-4 text-left">
      <p className="text-xs font-bold uppercase tracking-wide text-gray-500">Mentor details (optional)</p>
      <div>

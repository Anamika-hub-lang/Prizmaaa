            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mt-5">
              <div>
                ...
                <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl text-white mt-1 leading-tight">
                  Choose your{' '}
                  <span className="font-script text-educture-orange text-3xl sm:text-4xl">category</span>
                </h1>
                <p className="text-sm text-gray-400 mt-2 max-w-xl leading-relaxed">
                  Career, domain skills, or future planning — pick a category, then your session type.
                </p>
              </div>
        ...
        <section className="py-8 sm:py-10">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-xs text-gray-500 text-center sm:text-left mt-4">
              Tap a category to see all session types and book on the next page.
            </p>
          </div>
        </section>

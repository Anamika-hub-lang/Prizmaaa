...
export function PortalProfilePage({ portal }: { portal: 'student' | 'teacher' }) {
  ...
  async function handleSaveDetails(e: React.FormEvent) {
    ...
    setError(null)
    if (!howFind) {
      setError('Select how you found Educture.')
      return
    }
    setSaving(true)
    try {
      await saveProfileDetails(getToken, {
        ...
        studentEducationLevel: accountRole === 'student' ? (educationLevel as StudentEducationLevel) : undefined,
        studentGradeOrProgram: accountRole === 'student' ? gradeOrProgram.trim() : undefined,
        studentLearningGoals: accountRole === 'student' ? learningGoals.trim() : undefined,
        mentorExpertise: accountRole === 'teacher' ? expertise.trim() : undefined,
        mentorExperienceYears: accountRole === 'teacher' ? Number(experienceYears) : undefined,
